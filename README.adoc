...
Let's start introducing a problem using https://es5.github.io/[ES5] (ECMAScript 5) or shortly JavaScript of
...
As we known, ClojureScript uses the Google Closure Compiler. Let's see how we can configure
